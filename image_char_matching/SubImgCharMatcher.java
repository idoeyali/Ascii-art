...
public class SubImgCharMatcher {
    ...
    private final Map<Character, Double> allBrightnessMap;// TODO sami
    ...
    public SubImgCharMatcher(char[] charset) {
        ...
        this.allBrightnessMap = new HashMap<>(); // TODO sami
    ...
    private void initializeMapEntry(char c, boolean isInitialized) {
        // Avoiding calculate the char brightness if its already calculated. TODO sami
        ...
        this.allBrightnessMap.put(c, charBrightness); // TODO sami
    }
