...
public class Shell {
    ...
    private int wrappedImageHeight;// TODO sami
    private int wrappedImageWidth;// TODO sami
    ...
    private void imageCommandHandler(String imagePath) throws IOException {
        ...
        this.wrappedImageHeight = ImageProcessing.closestPowerOfTwo(this.image.getHeight());// TODO sami
        this.wrappedImageWidth = ImageProcessing.closestPowerOfTwo(this.image.getWidth());
    }
    ...
    private void resolutionCommandHandler(String command) throws ResolutionException {
        int minCharsInRow = Math.max(1, this.wrappedImageWidth / this.wrappedImageHeight);// TODO sami
        int maxCharsInRow = this.wrappedImageWidth;// TODO sami
